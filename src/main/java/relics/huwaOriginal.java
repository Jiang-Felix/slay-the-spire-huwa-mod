...
public class huwaOriginal extends CustomRelic {
    public static final String ID = "huwaOriginal";
    private static final String IMG = "img/relics_Xiaobao/huwaOriginal.png";
    private static final String IMG_OTL = "img/relics_Xiaobao/outline/huwaOriginal.png";
    ...
    public AbstractRelic makeCopy() {
        return (AbstractRelic)new huwaOriginal();
    }
}